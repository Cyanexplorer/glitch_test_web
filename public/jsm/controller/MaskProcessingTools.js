...
class TransferTools2 extends SegTools {
    constructor(state, domElement) {
        ...
        let style = `width: calc(100% - ${(margin.left + margin.right)}px);height:calc(100% - ${(margin.top + margin.bottom)}px);position:absolute;top:${margin.top}px;left:${margin.left}px;`
